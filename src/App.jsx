...
const PROJECTS_INIT = [
  ...
  { id:"637-W",   name:"Walker",       client:"Michael Walker Jr", city:"Irvine", type:"Room Extension + Major Remodel", designer:"Molly",   status:"In Progress", phase:"Engineering Coordination",   start:"2025-12-30", end:"2026-02-24", pct:40, stamp:"", permit:"", contract:15525, invoiced:0, team:[], workflow:[], contracts:[], notes:"Arch $11,960 + Structural $3,565 = $15,525. Retainer $1,000. TRUADDITIONS CORP in-house. DocuSign 8A997607. Phone: (626) 236-7606. Email: mjwjr11@gmail.com. 15422 Alsace Cir, Irvine, CA 92618." },
  // ── TAN — PRESERVED EXACTLY ─────────────────────────────────────────────────
  { id:"638",     name:"Tan",          client:"Wendy/Wenjin Tan", city:"San Clemente", type:"Preliminary Research + New Home Redesign", designer:"Molly",   status:"In Progress", phase:"Matterport and Measurement", start:"2026-01-29", end:"2026-03-26", pct:10, stamp:"", permit:"", contract:57054, invoiced:0, team:[], workflow:[], contracts:[], notes:"Two contracts: 91 Marbella $24,013 + 25 Cantilena $33,041. Both San Clemente 92673. Verify two properties with Molly. Phone: (951) 463-1098. Email: Wendytan1213@gmail.com." },
